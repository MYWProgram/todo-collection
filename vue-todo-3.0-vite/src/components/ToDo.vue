<template>
	<div class="ToDo">
		...
		<section class="ToDoWrapper">
			<section class="ToDoContent"><to-do-item v-for="item in todoList" :key="item.id" :item="item" @delete="deleteItem"></to-do-item></section>
...
export default {
	...
	setup() {
		 ...
		 */
		const logo = Logo;
		const todoList = ref([{ id: 1, text: 'Eat breakfast' }, { id: 2, text: 'Clean the house' }]);
